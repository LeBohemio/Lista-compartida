...
export default function CreateListModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-end justify-center bg-black/40 sm:items-center" onClick={onClose}>
      <div
        className="relative max-h-[90vh] w-full max-w-md overflow-y-auto rounded-t-2xl bg-white p-6 shadow-xl sm:rounded-2xl dark:bg-[var(--color-surface)]"
      ...
      >
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <label className="flex items-start gap-3 rounded-lg border border-slate-200 p-3 dark:border-[var(--color-surface-border)]">
            <input
              type="checkbox"
