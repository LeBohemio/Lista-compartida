...
// Layout compartido por las 3 pantallas principales de la app (Mis listas,
// Contactos, Ajustes): pinta la pantalla que toque vía <Outlet /> y encima
// la barra de navegación inferior, siempre visible. Se monta una única vez
// (React Router no la vuelve a montar al cambiar de pestaña), así que la
// suscripción realtime de useContactRequests no se reinicia en cada
// cambio de pestaña.
//
